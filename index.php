            ...
            <div class="container">
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <a href="about.php" class="primary-btn">Upload Prescription <i class="fa fa-medkit"></i></a>
                    </div>
                    <div class="col-md-6">
            ...
            <div class="container">
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="about.php" class="primary-btn">Get Appointment <i class="fa fa-calendar"></i></a>
                    </div>
                </div>
            </div>
        </section>
